...
\begin{itemize}
    ...
    \item \textbf{Extended catalog v17.1} (236 galaxies with $\sigma_v$, $\log M_{\rm vir}$): Available upon request to pg@gfo.bzh or via GitHub repository (JANUS-Z)
\end{itemize}
