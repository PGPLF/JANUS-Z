...
Table~\ref{tab:galaxies_detail} presents the detailed predictions for each galaxy.

\begin{table*}[t]
\centering
\small
\caption{Individual galaxy predictions: ΛCDM vs JANUS ($\rho_-/\rho_+ = 64$)}
\label{tab:galaxies_detail}
\begin{tabular}{lccccccc}
\toprule
Galaxy ID & $z$ & $\log(M_*/M_\odot)_{\rm obs}$ & $\sigma$ & $\log M_{\rm \Lambda CDM}$ & $\log M_{\rm JANUS}$ & Gap$_{\Lambda}$ & Gap$_{\rm J}$ \\
\midrule
JADES-GS-z14-0 & 14.32 & 9.80 & 0.30 & 3.90 & 4.80 & 5.90 & 5.00 \\
JADES-GS-z14-1 & 13.90 & 9.89 & 0.35 & 3.92 & 4.82 & 5.97 & 5.07 \\
JADES-GS-z13-0 & 13.20 & 9.40 & 0.25 & 3.96 & 4.86 & 5.44 & 4.54 \\
CEERS-93316 & 12.50 & 9.10 & 0.20 & 3.99 & 4.89 & 5.11 & 4.21 \\
GLASS-z12 & 12.34 & 9.00 & 0.22 & 4.00 & 4.90 & 5.00 & 4.10 \\
CEERS-1670 & 11.95 & 9.41 & 0.28 & 4.01 & 4.91 & 5.40 & 4.50 \\
MACS1149-JD1 & 11.85 & 9.20 & 0.25 & 4.02 & 4.92 & 5.18 & 4.28 \\
SMACS-z11.5 & 11.50 & 9.00 & 0.30 & 4.03 & 4.93 & 4.97 & 4.07 \\
UHZ1 & 11.20 & 9.15 & 0.24 & 4.04 & 4.94 & 5.11 & 4.21 \\
GHZ9 & 11.09 & 9.08 & 0.26 & 4.04 & 4.94 & 5.04 & 4.14 \\
UNCOVER-z11 & 11.00 & 8.79 & 0.20 & 4.05 & 4.95 & 4.74 & 3.84 \\
GHZ2 & 10.95 & 9.26 & 0.27 & 4.05 & 4.95 & 5.21 & 4.31 \\
CEERS-1019 & 10.85 & 9.10 & 0.23 & 4.05 & 4.95 & 5.05 & 4.15 \\
GN-z11 & 10.60 & 9.11 & 0.18 & 4.08 & 4.98 & 5.03 & 4.13 \\
HD1 & 10.70 & 8.70 & 0.25 & 4.07 & 4.97 & 4.63 & 3.73 \\
GLASS-z10 & 10.65 & 9.05 & 0.22 & 4.07 & 4.97 & 4.98 & 4.08 \\
\bottomrule
\end{tabular}
\vspace{0.1cm}
\\ \small Note: Gap = $\log M_{\rm obs} - \log M_{\rm pred}$ (in dex). All 16 galaxies exceed both models, but JANUS reduces average gap from 5.18 to 4.27 dex.
\end{table*}
