...
\\
\small \textit{Data availability}: Extended galaxy catalog (236 sources), bootstrap results, epsilon sensitivity analysis,\\
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.95\textwidth]{../../results/figures/fig_v17.2_killer_plot_suite.pdf}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.95\textwidth]{../../results/figures/fig_v17.2_clustering_analysis.pdf}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.95\textwidth]{../../results/figures/fig_v17.2_metallicity_evolution.pdf}
...
\begin{figure*}[ht!]
\centering
\includegraphics[width=0.95\textwidth]{../../results/figures/fig_v17.2_bootstrap_distributions.pdf}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.95\columnwidth]{../../results/figures/fig_v17.2_epsilon_sensitivity.pdf}
