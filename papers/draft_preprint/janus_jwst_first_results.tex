...
\author{
    ...
    \small (In collaboration with Claude Sonnet 4.5 - Anthropic)
}
...
This work was conducted using publicly available JWST data from the MAST archive. We thank the JADES, CEERS, UNCOVER, and GLASS teams for their exceptional observations and catalogs. Analysis was performed with assistance from Claude Sonnet 4.5 (Anthropic). All code and data are available at \url{https://github.com/PGPLF/JANUS-Z}.
